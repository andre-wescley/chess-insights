...
st.dataframe(view[columns].rename(columns={"opening_name": "Abertura", "first_10_moves": "Primeiros 10 lances"}).sort_values(["date","game_id"], ascending=[False, True]), use_container_width=True, hide_index=True)
